...
import com.fit.cfg.testpath.NormalizedTestpath;
...
public class UnaryNormalizer extends AbstractNormalizer implements ITestpathNormalizer {
	 ...
	 * Rewrite the test path into a corresponding test path
	 * <p>
	 * The content of condition is <b>negated automatically </b>its the statements
	 * after it belongs to the false branch
	 *
	 * @param tp
	 *            The input test path
	 * @return
	...
	/**
	 * Rewrite the current expression. If the next statement belong to false branch,
	...
	private void normalizeSingleBoolVariable(NormalCfgNode newConditionNode) {
		...
		/*
		 * Add tokens to the list. Some redudant tokens are removed, i.g., token "a" in
		 * array item "a[1]"
		 */
