...
public class Vnu_Pratical_Test extends AbstractJUnitTest {
	...
	public void test12() throws LineUnavailableException {
		Assert.assertEquals(true, generateTestdata(Paths.SYMBOLIC_EXECUTION_TEST, "add_digits(int)", new EO(2, 50.0f),
				IFunctionConfig.BRANCH_COVERAGE, new FuntionTestReportGUI()));
	}
	...
	public void test13() throws LineUnavailableException {
		Assert.assertEquals(true, generateTestdata(Paths.SYMBOLIC_EXECUTION_TEST, "reverse(long)", new EO(2, 80.0f),
				IFunctionConfig.STATEMENT_COVERAGE, new FuntionTestReportGUI()));
	}

	@Test
	public void test14() throws LineUnavailableException {
		Assert.assertEquals(true, generateTestdata(Paths.SYMBOLIC_EXECUTION_TEST, "check_prime(int)", new EO(2, 50.0f),
				IFunctionConfig.BRANCH_COVERAGE, new FuntionTestReportGUI()));
	}
	...
	public void test15() throws LineUnavailableException {
		Assert.assertEquals(true, generateTestdata(Paths.SYMBOLIC_EXECUTION_TEST, "check_armstrong(long long)",
				new EO(2, 80.0f), IFunctionConfig.STATEMENT_COVERAGE, new FuntionTestReportGUI()));
	}
	...
	public void test34() throws LineUnavailableException {
		Assert.assertEquals(true,
				generateTestdata(Paths.SYMBOLIC_EXECUTION_TEST, "merge(int[],int,int[],int,int[])",
						new EO(EO.UNSPECIFIED_NUM_OF_TEST_PATH, 75.0f), IFunctionConfig.BRANCH_COVERAGE,
	...
	public void test35() throws LineUnavailableException {
		Assert.assertEquals(true,
				generateTestdata(Paths.SYMBOLIC_EXECUTION_TEST, "merge(int[],int,int[],int,int[])",
						new EO(EO.UNSPECIFIED_NUM_OF_TEST_PATH, 80.952385f), IFunctionConfig.STATEMENT_COVERAGE,
						new FuntionTestReportGUI()));
	}
	...
	public void test37() throws LineUnavailableException {
		Assert.assertEquals(true,
				generateTestdata(Paths.SYMBOLIC_EXECUTION_TEST, "check_anagram(char[],char[])",
						new EO(EO.UNSPECIFIED_NUM_OF_TEST_PATH, 87.5f), IFunctionConfig.STATEMENT_COVERAGE,
						new FuntionTestReportGUI()));
	}
}
